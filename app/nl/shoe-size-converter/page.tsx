...
export const metadata: Metadata = { title: "Schoenmaat omrekenen: EU, US en UK", description: "Vergelijk Europese, Amerikaanse en Britse schoenmaten en voetlengte.", alternates: { canonical: "/nl/shoe-size-converter" } };
