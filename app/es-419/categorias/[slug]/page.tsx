...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      ...
      ...buildFullLanguageAlternates(`/es-419/categorias/${categoryPage.slug}`),
    },
    openGraph: {
      title: categoryPage.title,
      description: categoryPage.description,
      url: buildSiteUrl(`/es-419/categorias/${categoryPage.slug}`),
...
export default async function Es419CategoryPage({ params }: PageProps) {
  ...
  const pageUrl = buildSiteUrl(`/es-419/categorias/${categoryPage.slug}`);
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Categorías",
        item: buildSiteUrl("/es-419/categorias"),
      },
      {
        "@type": "ListItem",
        position: 3,
  ...
  return (
    <CategoryPageLayout
      ...
      breadcrumbs={[
        ...
        { label: "Categorías", href: "/es-419/categorias" },
              ...
              >
                ...
                {index === 1 && featuredUnit && (
                  <p className="category-inline-link">
                    ...
                    <a href={`/es-419/guias-de-unidades/${featuredUnit.slug}`}>
