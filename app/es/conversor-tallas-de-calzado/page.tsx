...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/es/conversor-tallas-de-calzado",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/es/conversor-tallas-de-calzado"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/es/categorias/longitud">Conversión de unidades de longitud</Link>
            </li>
          </ul>
        </section>
