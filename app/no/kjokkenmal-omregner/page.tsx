...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/no/kjokkenmal-omregner",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/no/kjokkenmal-omregner"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="category-article-content">
          ...
          <p>
            ...
            <Link href="/no/oppskriftomregner">oppskriftomregneren</Link>.
          </p>
        </section>
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/no/kategorier/masse">Omregning av masseenheter</Link>
            </li>
          </ul>
        </section>
