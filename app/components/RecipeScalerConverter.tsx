...
const copy = {
  ...
  es: {
    ...
    originalServingsLabel: "Raciones originales",
    targetServingsLabel: "Raciones deseadas",
  ...
  pt: {
    ...
    factorLabel: "Multiplicador",
    originalServingsLabel: "Porções originais",
    targetServingsLabel: "Porções desejadas",
