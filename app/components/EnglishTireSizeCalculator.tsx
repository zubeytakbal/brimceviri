...
type TireValues = { width: string; aspect: string; rim: string };

function toInput(values: TireValues): TireSizeInput {
  return { widthMm: number(values.width), aspectRatioPercent: number(values.aspect), rimDiameterInch: number(values.rim) };
}
