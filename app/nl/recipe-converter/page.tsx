...
export const metadata: Metadata = { title: "Recept omrekenen", description: "Pas de hoeveelheden in een recept aan voor het gewenste aantal porties.", alternates: { canonical: "/nl/recipe-converter" } };
