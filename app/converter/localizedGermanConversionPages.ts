...
const germanCategoryNames: Record<string, string> = {
  ...
  manyetik_alan: "Magnetfeld",
  manyetik_aki: "Magnetischer Fluss",
  viskozite_kinematik: "Kinematische Viskosität",
  isil_iletkenlik: "Wärmeleitfähigkeit",
  isi_akisi: "Wärmestromdichte",
  ozgul_isi: "Spezifische Wärmekapazität",
