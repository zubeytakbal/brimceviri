...
export const portugueseCategoryPages: LocalizedPortugueseCategoryPage[] = [
  ...
  },
  {
    ...
    unitTable: [
      { name: "Milimetro quadrado", symbol: "mm²", referenceValue: "0,000001 m²", system: "SI/métrico", commonUse: "Desenho técnico e áreas pequenas" },
      ...
      { name: "Quilometro quadrado", symbol: "km²", referenceValue: "1.000.000 m²", system: "SI/métrico", commonUse: "Cidades, países e zonas geográficas" },
  ...
  },
  {
    ...
    unitTable: [
      ...
      { name: "Quilometro por hora", symbol: "km/h", referenceValue: "≈0,278 m/s", system: "Métrico", commonUse: "Velocidade de veículos e limites rodoviários" },
      ...
      { name: "Quilometro por minuto", symbol: "km/min", referenceValue: "≈16,67 m/s", system: "Métrico", commonUse: "Cálculos de velocidade em distâncias curtas" },
      { name: "Quilometro por segundo", symbol: "km/s", referenceValue: "1000 m/s", system: "Métrico", commonUse: "Velocidade de naves espaciais e corpos celestes" },
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Referencia do zero absoluto", value: "Vácuo total" },
    ],
    sections: [
      {
    ...
    unitTable: [
      ...
      { name: "Milimetro de coluna de água", symbol: "mmH₂O", referenceValue: "≈9,80665 Pa", system: "Fora do SI", commonUse: "Medições de baixa pressão e ventilação" },
