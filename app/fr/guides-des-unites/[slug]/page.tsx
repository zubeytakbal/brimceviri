...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/fr/guides-des-unites/${unitPage.slug}`,
      ...buildFullLanguageAlternates(`/fr/guides-des-unites/${unitPage.slug}`),
    },
    openGraph: {
      title: `${unitPage.name} — ${unitPage.categoryName}`,
      description: unitPage.shortDescription,
      url: buildSiteUrl(`/fr/guides-des-unites/${unitPage.slug}`),
