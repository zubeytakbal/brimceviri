...
export default function BoltTorqueCalculatorUz() {
  ...
  return (
    <div className="category-general-converter">
      <div className="engineering-calculator-card">
        ...
        >
          <strong>
            Tavsiya Etilgan Boshlang&apos;ich Tork: {formatValue(recommendedTorque, 2)} Nm
          </strong>
        </div>
      </div>
      ...
      <div className="engineering-calculator-card">
        <div className="engineering-targets">
          <span>Taxminiy Siqish Kuchi (K-Koeffitsient Usuli)</span>
        </div>

        <div className="paint-calculator-grid">
          <label className="category-general-converter-field">
            <span>K Koeffitsienti</span>
            <input
              type="text"
              inputMode="decimal"
              value={kFactorInput}
        ...
        >
          {!clampForce ? (
            <strong>To&apos;g&apos;ri K koeffitsienti kiritib taxminiy siqish kuchini ko&apos;rishingiz mumkin.</strong>
          ) : (
            <strong>Taxminiy Siqish Kuchi: {formatValue(clampForce)} N (~{formatValue(clampForce / 1000, 2)} kN)</strong>
          )}
        </div>
      </div>
      ...
      <div className="conversion-table-wrap">
        <table className="conversion-table">
          <caption>Bolt Siqish Torki Jadvali (DIN 13, Nm)</caption>
          <thead>
            <tr>
      ...
      <p className="calculator-usage-hint">
        <strong>Muhim:</strong> Bu qiymatlar umumiy, dag&apos;al
        boshlang&apos;ich ma&apos;lumotnomalardir — quruq/yengil
        moylangan, standart yuza qoplamali boltlar uchun amal qiladi.
        Muhim yoki standartga bo&apos;ysunuvchi montajlarda har doim
        dizayner yoki bolt ishlab chiqaruvchisi ko&apos;rsatgan aniq
        tork qiymati asos qilib olinishi kerak.
      </p>
    </div>
  );
}
