...
const copy: Record<CalculatorLocale, PageCopy> = {
  tr: {
    ...
    intro: [
      "Bu araç, ölçülen veya sahada okunan hat akımından yaklaşık gücü çıkarmak için kullanılır. Tek faz, üç faz ve DC seçenekleri desteklenir.",
      "Özellikle mevcut bir hattın güç tahmini, yük dengeleme kontrolü, jeneratör veya UPS boyutlandırma çalışmalarında hızlı ilk kontrol aracı olarak faydalıdır.",
    ],
    formulas: [
      "Tek faz: P = V x I x cos phi x eta",
      "Üç faz: P = sqrt(3) x V x I x cos phi x eta",
      "DC: P = V x I x eta",
    ],
    variables: [
      { term: "I", explanation: "Ölçülen veya girilen hat akımıdır." },
      ...
      { term: "eta", explanation: "Verim katsayısıdır; akımdan çıkış gücüne gidiliyorsa hesaba dahil edilir." },
      { term: "P", explanation: "Hesaplanan yaklaşık güçtür." },
    ],
    examples: [
      {
        title: "9.59 A, 400 V, üç faz, cos phi 0.9 ve verim 92 için güç",
        body: "P = 1.732 x 400 x 9.59 x 0.9 x 0.92 yaklaşık 5.5 kW. Bu sonuç, kW to Amper aracındaki aynı örneğin tersidir.",
      },
      {
        title: "9.15 A, 230 V tek faz, cos phi 0.95 ve verim 100 için güç",
        body: "P = 230 x 9.15 x 0.95 yaklaşık 2 kW.",
      },
    ],
    applications: [
      ...
      "Sayaç veya pens ampermetre okumalarından hızlı güç kontrolü",
    ],
    limitations: [
      "Bu araç yaklaşık güç verir; harmonik, kalkış akımı, ortam sıcaklığı ve ölçüm toleransları dahil değildir.",
      "Üç faz seçeneğinde gerilim değeri fazlar arası hat gerilimi olarak yorumlanır.",
      "Verim varsayılan olarak kullanıcı girdisine bağlıdır; akım zaten elektriksel giriş akımıysa verimi 1 veya 100 olarak girebilirsiniz.",
    ],
    sources: [
      {
  ...
  ar: {
    ...
    description:
      "احسب القدرة التقريبية من تيار الخط والجهد ومعامل القدرة والكفاءة بواجهة عربية.",
    heroEyebrow: "حاسبة كهربائية",
    heroResultHeading: "نتيجة القدرة",
    ...
    intro: [
      "هذه الأداة مناسبة عندما تمتلك قراءة تيار فعلية وتحتاج تقديرا سريعا للقدرة الكهربائية.",
      "وهي مفيدة في مراجعات الموقع وموازنة الأحمال والتحقق من الخطوط الموجودة.",
    ],
    formulas: [
      "أحادي الطور: P = V x I x cos phi x eta",
      "ثلاثي الطور: P = sqrt(3) x V x I x cos phi x eta",
      "تيار مستمر: P = V x I x eta",
    ],
    variables: [
      { term: "I", explanation: "تيار الخط المقاس أو المدخل." },
      { term: "V", explanation: "جهد النظام." },
      { term: "cos phi", explanation: "معامل القدرة لأنظمة AC." },
      { term: "eta", explanation: "الكفاءة إذا كانت مطلوبة في التقدير." },
      { term: "P", explanation: "القدرة الناتجة من الحساب." },
    ],
    examples: [
      {
        title: "9.59 A عند 400 V ثلاثي الطور",
        body: "مع معامل قدرة 0.9 وكفاءة 92% تكون القدرة حوالي 5.5 kW.",
      },
      {
        title: "9.15 A عند 230 V أحادي الطور",
        body: "مع معامل قدرة 0.95 تكون القدرة حوالي 2 kW.",
      },
    ],
    applications: [
      "تقدير القدرة من قراءة تيار موجودة",
      "فحص توزيع الأحمال",
      "مراجعة لوحات التغذية",
      "التخطيط للمولد أو UPS",
    ],
    limitations: [
      "النتيجة تقريبية ولا تشمل ظروف البدء أو التوافقيات أو فروق التشغيل الواقعية.",
      "في النمط الثلاثي الطور يفسر الجهد كجهد خط إلى خط.",
      "إذا كان التيار يمثل دخلًا كهربائيًا مباشرًا فقد تحتاج إلى ضبط الكفاءة وفق الحالة.",
    ],
    sources: [
      {
        label: "IEC electrotechnical concepts and symbols",
