...
export const es419ConversionPages: LocalizedSpanishConversionPage[] =
  conversionPages
...
export function findEs419ConversionPage(slug: string) {
  return es419ConversionPages.find((page) => page.slug === slug);
}

export function findEs419ConversionPageByTurkishSlug(sourceSlug: string) {
  return es419ConversionPages.find((page) => page.sourceSlug === sourceSlug);
}
