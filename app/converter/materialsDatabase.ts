...
export const materialsDatabase: MaterialDensityEntry[] = [
  ...
  { id: "dizel", nameTr: "Dizel", category: "sivi", densityKgM3: 832, variabilityNote: "Viskozite değeri sıcaklığa ve yakıt standardına göre değişir; verilen değer tipik bir yaklaşık referanstır." },
  { id: "motor-yagi", nameTr: "Motor Yağı", category: "sivi", densityKgM3: 870, variabilityNote: "Viskozite, yağın SAE derecesine (5W-30, 10W-40 gibi) ve sıcaklığa göre büyük ölçüde değişir; verilen değer 40°C'deki tipik bir çok dereceli yağ için yaklaşık bir referanstır." },
  ...
  { id: "fren-hidroligi", nameTr: "Fren Hidroliği", category: "sivi", densityKgM3: 1050, variabilityNote: "Viskozite, DOT sınıfına (DOT3, DOT4, DOT5 gibi) göre değişir; verilen değer tipik bir DOT3/4 fren hidroliği için yaklaşık bir referanstır." },
  { id: "antifriz", nameTr: "Antifriz", category: "sivi", densityKgM3: 1110, variabilityNote: "Viskozite, su ile karışım oranına ve sıcaklığa göre değişir; verilen değer tipik bir %50 karışım için yaklaşık bir referanstır." },
  ...
  { id: "ldpe", nameTr: "Alçak Yoğunluklu Polietilen (LDPE)", category: "plastik", densityKgM3: 920, variabilityNote: "Isı iletkenliği ve elastisite modülü değerleri, üretim yöntemine ve katkı maddelerine göre değişebilir; verilen değerler genel referans niteliğindedir." },
  ...
  { id: "polistiren", nameTr: "Polistiren (PS)", category: "plastik", densityKgM3: 1050, variabilityNote: "Isı iletkenliği ve elastisite modülü değerleri katı (genel amaçlı) polistiren içindir; genleştirilmiş (EPS) veya ekstrüde (XPS) köpük formları çok farklı (çok daha düşük) ısı iletkenliğine sahiptir." },
  ...
  { id: "maun", nameTr: "Maun", category: "ahsap", densityKgM3: 600, variabilityNote: "Ahşabın elastisite modülü, nem oranına, büyüme koşullarına ve lif yönüne göre önemli ölçüde değişebilir; verilen değer, lif doğrultusunda tipik bir ortalamadır." },
  { id: "ceviz-agaci", nameTr: "Ceviz Ağacı", category: "ahsap", densityKgM3: 610, variabilityNote: "Ahşabın elastisite modülü, nem oranına, büyüme koşullarına ve lif yönüne göre önemli ölçüde değişebilir; verilen değer, lif doğrultusunda tipik bir ortalamadır." },
  { id: "tik", nameTr: "Tik", category: "ahsap", densityKgM3: 650, variabilityNote: "Ahşabın elastisite modülü, nem oranına, büyüme koşullarına ve lif yönüne göre önemli ölçüde değişebilir; verilen değer, lif doğrultusunda tipik bir ortalamadır." },
  { id: "hus", nameTr: "Huş", category: "ahsap", densityKgM3: 670, variabilityNote: "Ahşabın elastisite modülü, nem oranına, büyüme koşullarına ve lif yönüne göre önemli ölçüde değişebilir; verilen değer, lif doğrultusunda tipik bir ortalamadır." },
  { id: "kayin", nameTr: "Kayın", category: "ahsap", densityKgM3: 720, variabilityNote: "Ahşabın elastisite modülü, nem oranına, büyüme koşullarına ve lif yönüne göre önemli ölçüde değişebilir; verilen değer, lif doğrultusunda tipik bir ortalamadır." },
  { id: "mese-agaci", nameTr: "Ahşap (Meşe)", category: "ahsap", densityKgM3: 750 },

  // ---- Yapı Malzemeleri ----
  { id: "cimento-tozu", nameTr: "Çimento Tozu", category: "yapi-malzemesi", densityKgM3: 1440, variabilityNote: "Gevşek tozun ısı iletkenliği, paketlenme yoğunluğuna ve neme göre değişebilir; verilen değer kuru, gevşek toz için yaklaşık bir referanstır." },
