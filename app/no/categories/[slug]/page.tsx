...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/no/categories/${categoryPage.slug}`,
      ...buildFullLanguageAlternates(`/no/categories/${categoryPage.slug}`),
    },
    openGraph: {
      title: categoryPage.title,
      description: categoryPage.description,
      url: buildSiteUrl(`/no/categories/${categoryPage.slug}`),
...
export default async function NorwegianCategoryPage({ params }: PageProps) {
  ...
  const pageUrl = buildSiteUrl(`/no/categories/${categoryPage.slug}`);
  ...
  return (
    <CategoryPageLayout
      ...
      breadcrumbs={[
        { label: "Hjem", href: "/no" },
        { label: "Kategorier", href: "/no/categories" },
              ...
              >
                ...
                {index === 1 && featuredUnit && (
                  <p className="category-inline-link">
                    ...
                    <a href={`/no/unit-guides/${featuredUnit.slug}`}>
