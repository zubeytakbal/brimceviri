...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/da/kategorier/${categoryPage.slug}`,
      ...buildFullLanguageAlternates(`/da/kategorier/${categoryPage.slug}`),
    },
    openGraph: {
      title: categoryPage.title,
      description: categoryPage.description,
      url: buildSiteUrl(`/da/kategorier/${categoryPage.slug}`),
...
export default async function DanishCategoryPage({ params }: PageProps) {
  ...
  const pageUrl = buildSiteUrl(`/da/kategorier/${categoryPage.slug}`);
  ...
  return (
    <CategoryPageLayout
      ...
      breadcrumbs={[
        { label: "Hjem", href: "/da" },
        { label: "Kategorier", href: "/da/kategorier" },
