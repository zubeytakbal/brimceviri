...
export const metadata = {
  ...
  alternates: {
    canonical: "/da/historiske-enheder",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/da/historiske-enheder"),
          ...
          content: (
            <>
              <p>
                ...
                <Link href="/da/kategorier/laengde">det fuldstændige længdebibliotek</Link>.
              </p>
          ...
          content: (
            <>
              <p>
                ...
                <Link href="/da/kategorier/masse">det fuldstændige massebibliotek</Link>.
              </p>
              <CategoryUnitConverter
                category="kutle"
                locale="da"
