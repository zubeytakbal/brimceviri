...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/pt/categorias/${categoryPage.slug}`,
      ...buildFullLanguageAlternates(`/pt/categorias/${categoryPage.slug}`),
    },
    openGraph: {
      title: categoryPage.title,
      description: categoryPage.description,
      url: buildSiteUrl(`/pt/categorias/${categoryPage.slug}`),
...
export default async function PortugueseCategoryPage({ params }: PageProps) {
  ...
  const pageUrl = buildSiteUrl(`/pt/categorias/${categoryPage.slug}`);
  ...
  return (
    <CategoryPageLayout
      ...
      breadcrumbs={[
        ...
        { label: "Categorias", href: "/pt/categorias" },
