...
export const metadata = {
  ...
  alternates: {
    canonical: "/es/unidades-historicas",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/es/unidades-historicas"),
          ...
          content: (
            <>
              <p>
                ...
                abre la{" "}
                <Link href="/es/categorias/longitud">biblioteca completa de longitudes</Link>.
              </p>
          ...
          content: (
            <>
              <p>
                ...
                <Link href="/es/categorias/masa">guía completa de unidades de masa</Link>.
              </p>
              <CategoryUnitConverter
                category="kutle"
                locale="es"
