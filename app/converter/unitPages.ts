...
const unitDescriptions: Record<string, UnitDescription> = {
  ...
  "feddan": {
    shortDescription: "Feddan, Mısır ve bazı komşu Arap ülkelerinde tarım arazisi ölçümünde kullanılan geleneksel bir alan birimidir. 1 feddan yaklaşık 4200,833 metrekareye eşittir.",
    historySummary: "Feddan'ın kökeni, bir çift öküzün bir günde sürebileceği tarla büyüklüğüne dayanır — tıpkı İngiliz akrenin veya Osmanlı dönümünün kökenine benzer şekilde. Mısır'da resmi arazi ölçümü ve tapu kayıtlarında hâlâ standart birim olarak kullanılır.",
    measurementSystem: "Mısır'a özgü geleneksel birim (metrik sisteme entegre)",
    siEquivalent: "1 feddan ≈ 4200,833 m² = 24 kırat (arazi)",
    commonUses: "Mısır'da tarım arazisi, emlak ilanları ve tapu kayıtlarında arazi büyüklüğü",
  },
  "kirat-arazi": {
    shortDescription: "Kırat (arazi), Mısır'da feddan'ın alt birimi olarak kullanılan bir alan ölçüsüdür ve mücevherattaki ayar kıratıyla karıştırılmamalıdır. 1 kırat, 1 feddan'ın 24'te birine eşittir.",
    historySummary: "Bu birim, feddan'ın daha küçük arazi parçalarını ifade etmek için 24 eşit parçaya bölünmesinden doğmuştur; miras yoluyla bölünen tarım arazilerinin paylaşımında sıkça kullanılır.",
    measurementSystem: "Mısır'a özgü geleneksel birim (feddan'ın alt birimi)",
    siEquivalent: "1 kırat (arazi) ≈ 175,035 m² = 1/24 feddan",
    commonUses: "Mısır'da küçük arazi parçalarının ve miras paylarının ölçümü",
  },
  "sehm-arazi": {
    shortDescription: "Sehm, Mısır'da kırat'ın alt birimi olarak kullanılan en küçük geleneksel arazi ölçüsüdür. 1 sehm, 1 kırat'ın 24'te birine eşittir.",
    historySummary: "Sehm, feddan-kırat-sehm sisteminin en ince kademesini oluşturur ve özellikle miras paylaşımında çok küçük arazi paylarının hassas biçimde ifade edilmesini sağlar.",
    measurementSystem: "Mısır'a özgü geleneksel birim (kırat'ın alt birimi)",
    siEquivalent: "1 sehm ≈ 7,293 m² = 1/24 kırat (arazi) = 1/576 feddan",
    commonUses: "Mısır'da miras yoluyla bölünen çok küçük arazi paylarının ölçümü",
  },
  "dekar": {
