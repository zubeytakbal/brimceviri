...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/es/conversor-de-recetas",
    languages: {
      tr: "/tarif-cevirici",
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/es/conversor-de-recetas"),
    ...
    <main className="all-conversions-page" lang="es">
      <div className="all-conversions-shell">
        ...
        <section className="category-article-content">
          ...
          <p>
            También puedes indicar el número de raciones originales y el
            número de raciones deseadas: el multiplicador se calculará
          ...
          <p>
            ...
            <Link href="/es/conversor-medidas-de-cocina">
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            <li>
              <Link href="/es/conversor-medidas-de-cocina">Conversor de medidas de cocina</Link>
            </li>
            <li>
