...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/es/conversor-medidas-de-cocina",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/es/conversor-medidas-de-cocina"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="category-article-content">
          ...
          <p>
            ...
            resultado es una referencia útil para el uso doméstico. Para
            recetas muy sensibles, conviene pesar los ingredientes.
          </p>
          ...
          <p>
            ...
            cucharaditas. La taza usada aquí corresponde a 240 mililitros
          ...
          <p>
            ...
            <Link href="/es/conversor-de-recetas">conversor de recetas</Link>.
          </p>
        </section>
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/es/conversor-tallas-de-calzado">Conversor de tallas de calzado</Link>
            </li>
            <li>
              <Link href="/es/unidades-historicas">Unidades de medida históricas</Link>
            </li>
            <li>
              <Link href="/es/categorias/masa">Conversión de unidades de masa</Link>
            </li>
          </ul>
        </section>
