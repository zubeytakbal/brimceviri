...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/it/categorie/${categoryPage.slug}`,
      ...buildFullLanguageAlternates(`/it/categorie/${categoryPage.slug}`),
    },
    openGraph: {
      title: categoryPage.title,
      description: categoryPage.description,
      url: buildSiteUrl(`/it/categorie/${categoryPage.slug}`),
...
export default async function ItalianCategoryPage({ params }: PageProps) {
  ...
  const pageUrl = buildSiteUrl(`/it/categorie/${categoryPage.slug}`);
  ...
  return (
    <CategoryPageLayout
      ...
      breadcrumbs={[
        { label: "Home", href: "/it" },
        { label: "Categorie", href: "/it/categorie" },
