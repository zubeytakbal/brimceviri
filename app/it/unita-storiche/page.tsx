...
export const metadata = {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/it/unita-storiche"),
          ...
          content: (
            <>
              <p>
                ...
                la{" "}
                <Link href="/it/categorie/lunghezza">biblioteca completa delle lunghezze</Link>.
              </p>
          ...
          content: (
            <>
              <p>
                ...
                tonnellata, apri la{" "}
                <Link href="/it/categorie/massa">biblioteca completa delle masse</Link>.
              </p>
              <CategoryUnitConverter
                category="kutle"
                locale="it"
