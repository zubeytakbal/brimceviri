...
export const metadata = {
  ...
  alternates: {
    canonical: "/es-419/unidades-historicas",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/es-419/unidades-historicas"),
          ...
          content: (
            <>
              <p>
                ...
                abre la{" "}
                <Link href="/es-419/categorias/longitud">biblioteca completa de longitudes</Link>.
              </p>
          ...
          content: (
            <>
              <p>
                ...
                la tonelada, abre la{" "}
                <Link href="/es-419/categorias/masa">biblioteca completa de masas</Link>.
              </p>
              <CategoryUnitConverter
                category="kutle"
                locale="es-419"
