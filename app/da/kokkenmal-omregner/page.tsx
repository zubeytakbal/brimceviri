...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/da/kokkenmal-omregner",
    languages: {
      ...
      no: "/no/kjokkenmal-omregner",
      da: "/da/kokkenmal-omregner",
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/da/kokkenmal-omregner"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="category-article-content">
          ...
          <p>
            ...
            <Link href="/da/opskriftomregner">opskriftomregneren</Link>.
          </p>
        </section>
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/da/skostorrelser">Skostørrelseomregner</Link>
            </li>
            <li>
              <Link href="/da/historiske-enheder">Historiske måleenheder</Link>
            </li>
            <li>
              <Link href="/da/kategorier/masse">Omregning af masseenheder</Link>
            </li>
          </ul>
        </section>
