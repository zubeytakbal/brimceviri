...
export const metadata = {
  ...
  alternates: {
    canonical: "/pt/unidades-historicas",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/pt/unidades-historicas"),
          ...
          content: (
            <>
              <p>
                ...
                modernas, abra a{" "}
                <Link href="/pt/categorias/comprimento">biblioteca completa de comprimentos</Link>.
              </p>
          ...
          content: (
            <>
              <p>
                ...
                tonelada, abra a{" "}
                <Link href="/pt/categorias/massa">biblioteca completa de massas</Link>.
              </p>
              <CategoryUnitConverter
                category="kutle"
                locale="pt"
        ...
        },
        {
          ...
          content: (
            <ul className="related-conversion-list">
              <li>
                <Link href="/pt/conversor-de-medidas-de-cozinha">Conversor de medidas de cozinha</Link>
              </li>
              <li>
                <Link href="/pt/conversor-de-receitas">Conversor de receitas</Link>
              </li>
              <li>
                <Link href="/pt/conversor-de-calcados">Conversor de numeração de calçados</Link>
              </li>
            </ul>
          ),
        },
