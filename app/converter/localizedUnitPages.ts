...
const curatedEnglishUnitPages: LocalizedUnitPage[] = [
  ...
  },
  {
    ...
    symbol: "rad",
    shortDescription:
      "The radian is the SI unit of angle, defined as the angle subtended at the center of a circle by an arc equal in length to the radius.",
    historySummary:
      "Proposed in 1873 by Scottish physicist James Thomson, it was adopted as the SI angle unit for its natural fit in mathematical calculations.",
    measurementSystem: "International System of Units (SI)",
    siEquivalent: "Base SI angle unit (2π rad = 360°)",
    commonUses: "Trigonometry, engineering calculations, angular velocity and acceleration formulas",
  },
  {
    locale: "en",
    sourceSlug: "derece",
    ...
    symbol: "°",
    shortDescription:
      "The degree is the most common practical angle unit, dividing a full circle into 360 equal parts.",
    historySummary:
      "Its origin traces to ancient Babylonian base-60 mathematics; 360's many divisors made it practical for everyday use.",
    measurementSystem: "Non-SI, widely used unit",
    siEquivalent: "1° = π/180 rad ≈ 0.01745 rad",
    commonUses: "Navigation, geography (latitude/longitude), engineering drawings, everyday angle measurement",
  },
  {
    locale: "en",
    sourceSlug: "gradyan",
    ...
    symbol: "gon",
    shortDescription:
      "The gradian divides a full circle into 400 equal parts, aligned with the decimal measurement system.",
    historySummary:
      "Proposed as part of the post-French Revolution decimal measurement movement, it remains in limited use today, mainly in geodesy and surveying.",
    measurementSystem: "Non-SI, decimal system unit",
    siEquivalent: "1 gon = π/200 rad = 0.9°",
    commonUses: "Geodesy, land surveying, some European engineering applications",
  },
  {
    locale: "en",
    sourceSlug: "hertz",
    ...
    symbol: "Hz",
    shortDescription:
      "The hertz is the SI unit of frequency, expressing how many times an event repeats per second.",
    historySummary:
      "Adopted as the SI unit in 1930, named after German physicist Heinrich Hertz for his experimental production of electromagnetic waves.",
    measurementSystem: "International System of Units (SI)",
    siEquivalent: "Base SI frequency unit (1 Hz = 1 cycle/second)",
    commonUses: "Sound waves, electrical current frequency, computer processor speed, radio waves",
  },
  {
    locale: "en",
    ...
    symbol: "kHz",
    shortDescription:
      "The kilohertz is one thousand hertz, used to express mid-range audio and radio signal frequencies.",
    historySummary:
      "It became the standard way to express AM radio frequencies as radio broadcasting developed.",
    measurementSystem: "International System of Units (SI, multiple unit)",
    siEquivalent: "1 kHz = 1000 Hz",
    commonUses: "AM radio frequencies, audio processing, ultrasonic devices",
  },
  {
    locale: "en",
    ...
    symbol: "MHz",
    shortDescription:
      "The megahertz is one million hertz, used to express FM radio, Wi-Fi and older computer processor speeds.",
    historySummary:
      "It became the practical standard unit for expressing high-frequency signals as radio and telecommunications technology developed.",
    measurementSystem: "International System of Units (SI, multiple unit)",
    siEquivalent: "1 MHz = 1,000,000 Hz",
    commonUses: "FM radio frequencies, Wi-Fi and Bluetooth bandwidth, older computer processor speeds",
  },
  {
    locale: "en",
    ...
    symbol: "GHz",
    shortDescription:
      "The gigahertz is one billion hertz, expressing modern computer processor speeds and high-frequency wireless communication.",
    historySummary:
      "As processor technology accelerated, it became the standard unit for expressing processor speeds and high-frequency systems like 5G and Wi-Fi.",
    measurementSystem: "International System of Units (SI, multiple unit)",
    siEquivalent: "1 GHz = 1,000,000,000 Hz",
    commonUses: "Computer and phone processor speeds, 5G and Wi-Fi frequency bands, radar systems",
  },
  {
    locale: "en",
    ...
    categoryName: "Volumetric Flow Rate",
    unit: "m³/s",
    name: "Cubic Meter per Second",
    symbol: "m³/s",
    shortDescription:
      "The cubic meter per second is the SI derived unit of volumetric flow rate, expressing the volume of fluid passing per second.",
    historySummary:
      "Derived directly from the SI units of volume and time, it is the standard unit for large-scale industrial and natural flow calculations.",
    measurementSystem: "International System of Units (SI)",
    siEquivalent: "Base SI volumetric flow rate unit",
    commonUses: "Large pump and turbine capacity, river discharge rate, industrial process design",
  },
  {
    locale: "en",
    ...
    symbol: "cfm",
    shortDescription:
      "CFM is a US-origin unit used to express airflow rate, especially in ventilation and HVAC systems.",
    historySummary:
      "Derived from the imperial foot, it became the standard measurement unit in the North American HVAC and fan industry.",
    measurementSystem: "Imperial/US customary system (non-SI)",
    siEquivalent: "1 CFM ≈ 0.000472 m³/s",
    commonUses: "Fan and ventilation system capacity, HVAC design, air filtration systems",
  },
  {
    locale: "en",
    ...
    categoryName: "Volumetric Flow Rate",
    unit: "gpm",
    name: "Gallons per Minute (GPM)",
    symbol: "gpm",
    shortDescription:
      "GPM is a common US-system unit for expressing pump and water system flow rate.",
    historySummary:
      "Based on the US gallon, it became the standard measurement unit in the North American water pump and irrigation industry.",
    measurementSystem: "Imperial/US customary system (non-SI)",
    siEquivalent: "1 GPM ≈ 0.0000631 m³/s",
    commonUses: "Water pump capacity, irrigation systems, industrial fluid transfer calculations",
  },
  {
    locale: "en",
    ...
    categoryName: "Mass Flow Rate",
    unit: "kg/s",
    name: "Kilogram per Second",
    symbol: "kg/s",
    shortDescription:
      "The kilogram per second is the SI derived unit of mass flow rate, expressing the mass passing per second.",
    historySummary:
      "Derived from the SI units of mass and time, it forms the basis of mass balance calculations in process engineering.",
    measurementSystem: "International System of Units (SI)",
    siEquivalent: "Base SI mass flow rate unit",
    commonUses: "Industrial process design, mass balance calculations, fuel and material flow rates",
  },
  {
    locale: "en",
    ...
    symbol: "kg/h",
    shortDescription:
      "The kilogram per hour is a practical unit for expressing smaller-scale mass flow rate values.",
    historySummary:
      "It became common for expressing smaller industrial and laboratory-scale flows more readably than kilograms per second.",
    measurementSystem: "International System of Units (SI, derived)",
    siEquivalent: "1 kg/h = 1/3600 kg/s ≈ 0.000278 kg/s",
    commonUses: "Food and chemical industry process lines, laboratory dosing systems",
  },
  {
    locale: "en",
