...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/pt/conversor-de-medidas-de-cozinha",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/pt/conversor-de-medidas-de-cozinha"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/pt/unidades-historicas">Unidades de medida históricas</Link>
            </li>
            <li>
              <Link href="/pt/categorias/massa">Conversão de unidades de massa</Link>
            </li>
          </ul>
        </section>
