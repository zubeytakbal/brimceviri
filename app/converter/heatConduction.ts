...
> = {
  tr: [
    ...
    { id: "zinc", label: "Çinko", value: "116" },
    { id: "nickel", label: "Nikel", value: "90.9" },
    { id: "tin", label: "Kalay", value: "66.6" },
    { id: "gold", label: "Altın", value: "315" },
    { id: "silver", label: "Gümüş", value: "429" },
    { id: "platinum", label: "Platin", value: "72" },
    { id: "iron", label: "Demir", value: "80" },
    { id: "cast-iron", label: "Dökme Demir", value: "55" },
    { id: "chromium", label: "Krom", value: "94" },
    { id: "magnesium", label: "Magnezyum", value: "156" },
    { id: "pvc", label: "PVC", value: "0.17" },
    { id: "pet", label: "PET Plastik", value: "0.20" },
    { id: "polycarbonate", label: "Polikarbonat", value: "0.20" },
    { id: "ptfe", label: "Teflon (PTFE)", value: "0.25" },
    { id: "hdpe", label: "HDPE", value: "0.44" },
    { id: "nylon", label: "Naylon", value: "0.21" },
    { id: "acrylic", label: "Akrilik", value: "0.18" },
    { id: "abs", label: "ABS Plastik", value: "0.1" },
    { id: "hydrogen", label: "Hidrojen", value: "0.182" },
    { id: "helium", label: "Helyum", value: "0.152" },
    { id: "nitrogen", label: "Azot", value: "0.026" },
    { id: "oxygen", label: "Oksijen", value: "0.026" },
    { id: "carbonDioxide", label: "Karbondioksit", value: "0.0166" },
    { id: "argon", label: "Argon", value: "0.0177" },
    { id: "methane", label: "Metan", value: "0.0332" },
    { id: "pine", label: "Ahşap (Çam)", value: "0.12" },
    { id: "oak", label: "Ahşap (Meşe)", value: "0.17" },
    { id: "tungsten", label: "Tungsten", value: "173" },
    { id: "molybdenum", label: "Molibden", value: "138" },
    { id: "niobium", label: "Niyobyum", value: "53.7" },
    { id: "palladium", label: "Paladyum", value: "71.8" },
    { id: "vanadium", label: "Vanadyum", value: "30.7" },
    { id: "bismuth", label: "Bizmut", value: "8.4" },
    { id: "cadmium", label: "Kadmiyum", value: "92" },
    { id: "balsa", label: "Balsa", value: "0.04" },
    { id: "poplar", label: "Kavak", value: "0.09" },
    { id: "granite", label: "Granit", value: "2.8" },
    { id: "basalt", label: "Bazalt", value: "3.5" },
    { id: "marble", label: "Mermer", value: "3.5" },
    { id: "gypsum", label: "Alçı", value: "2.3" },
    { id: "sand", label: "Kum", value: "0.7" },
    { id: "gravel", label: "Çakıl", value: "0.7" },
    { id: "brick", label: "Tuğla", value: "0.81" },
    { id: "sandstone", label: "Kumtaşı", value: "2.3" },
    { id: "limestone", label: "Kireçtaşı", value: "2.3" },
    { id: "asphalt", label: "Asfalt", value: "0.7" },
    { id: "cedar", label: "Sedir", value: "0.19" },
    { id: "bronze", label: "Bronz", value: "75" },
    { id: "ice", label: "Buz", value: "2.2" },
    { id: "propane", label: "Propan", value: "0.018" },
    { id: "butane", label: "Bütan", value: "0.016" },
