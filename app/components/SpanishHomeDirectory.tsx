...
const nicheCards: Array<{
  ...
  {
    id: "shoe-size",
    href: "/es/conversor-tallas-de-calzado",
  ...
  {
    id: "kitchen-measures",
    href: "/es/conversor-medidas-de-cocina",
      ...
      <div className="directory-shell directory-content">
        <section className="directory-section">
          <header className="directory-section-header">
            ...
            <Link className="directory-section-link" href="/es/categorias">
