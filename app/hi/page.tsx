...
export const metadata: Metadata = {
  title: "यूनिट कन्वर्टर और इकाई परिवर्तन कैलकुलेटर",
  ...
  openGraph: { title: "यूनिट कन्वर्टर और इकाई परिवर्तन कैलकुलेटर", url: buildSiteUrl("/hi"), locale: "hi_IN" },
};
  ...
  return (
    <main className="all-conversions-page" lang="hi">
      <div className="all-conversions-shell">
        <header className="all-conversions-header"><h1>यूनिट कन्वर्टर और इकाई परिवर्तन कैलकुलेटर</h1><p>इकाइयों की जोड़ी चुनें और तुरंत परिणाम पाने के लिए मान लिखें।</p></header>
