...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/sv/kategorier/${categoryPage.slug}`,
      ...buildFullLanguageAlternates(`/sv/kategorier/${categoryPage.slug}`),
    },
    openGraph: {
      title: categoryPage.title,
      description: categoryPage.description,
      url: buildSiteUrl(`/sv/kategorier/${categoryPage.slug}`),
...
export default async function SwedishCategoryPage({ params }: PageProps) {
  ...
  const pageUrl = buildSiteUrl(`/sv/kategorier/${categoryPage.slug}`);
  ...
  return (
    <CategoryPageLayout
      ...
      breadcrumbs={[
        { label: "Hem", href: "/sv" },
        { label: "Kategorier", href: "/sv/kategorier" },
