...
const copy: Record<CalculatorLocale, PageCopy> = {
  tr: {
    breadcrumbs: [
      ...
      { label: "Gerilim Düşümü Hesaplama" },
    ],
    ...
    formulas: [
      ...
      "Tek faz ve DC için k = 2 (gidiş-dönüş iletkeni)",
      "Üç faz için k = √3",
    ],
    variables: [
      ...
      { term: "A", explanation: "İletken kesit alanıdır." },
    ...
    examples: [
      {
        title: "400 V, 20 A, 50 m, 6 mm², bakır, üç faz",
        body: "ΔU = 1.732 x 20 x 50 x 0.0175 / 6 yaklaşık 5.05 V, yani %1.26 düşüm. Hat sonu gerilimi yaklaşık 394.95 V olur.",
      },
      {
        title: "230 V, 16 A, 30 m, 2.5 mm², bakır, tek faz",
        body: "ΔU = 2 x 16 x 30 x 0.0175 / 2.5 yaklaşık 6.72 V, yani %2.92 düşüm. Hat sonu gerilimi yaklaşık 223.28 V olur.",
      },
    ],
    applications: [
      "İç tesisat kontrolü",
      ...
      "Mevcut bir kesitin seçilen mesafede yeterli olup olmadığının doğrulanması",
    ],
    limitations: [
      "Bu hesap yalnızca dirence bağlı gerilim dusumunu kapsar; reaktans (endüktif düşüm), harmonikler ve kalkış akımları dahil değildir.",
      "Kullanılan özgül direnç değerleri (bakır 0.0175, alüminyum 0.028 Ω·mm²/m) yaklaşık 20°C referans değerleridir; gerçek iletken sıcaklığı sonucu etkiler.",
      "Bu araç akım taşıma kapasitesini (ampacity) kontrol etmez. Seçilen kesitin dosema yöntemine, ortam sıcaklığına ve ilgili elektrik tesisat yönetmeliğine göre ayrıca doğrulanması gerekir.",
    ],
    sources: [
      {
