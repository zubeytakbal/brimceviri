...
const oneTokenUnits: Record<string, KitchenUnit> = {
  ...
  taza: "bardak",
  tazas: "bardak",
  cucharada: "yemekKasigi",
  cucharadas: "yemekKasigi",
  cucharadita: "cayKasigi",
  cucharaditas: "cayKasigi",
  gramo: "gram",
  gramos: "gram",
  mililitro: "ml",
  mililitros: "ml",
  ...
  tazza: "bardak",
  tazze: "bardak",
  cucchiaio: "yemekKasigi",
  cucchiai: "yemekKasigi",
  cucchiaino: "cayKasigi",
  cucchiaini: "cayKasigi",
  grammo: "gram",
  grammi: "gram",
  millilitro: "ml",
  millilitri: "ml",
  ...
  kop: "bardak",
  kopper: "bardak",
  spiseske: "yemekKasigi",
  spiseskeer: "yemekKasigi",
  teske: "cayKasigi",
  teskeer: "cayKasigi",
};
...
const ingredientMatchEntries: Array<{
  ...
  entries.push({
    key: row.key,
    normalized: normalizeText(kitchenIngredientLabels.fr[row.key]),
  });
  entries.push({
    key: row.key,
