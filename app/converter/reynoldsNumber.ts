...
export const fluidPresets: Record<CalculatorLocale, FluidPreset[]> = {
  tr: [
    ...
    { id: "gasoline", label: "Benzin", densityValue: "740", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "0.55", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "milk", label: "Süt", densityValue: "1030", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "3", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "acetone", label: "Aseton", densityValue: "784", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "0.316", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "kerosene", label: "Gazyağı", densityValue: "810", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "1.64", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "benzene", label: "Benzen", densityValue: "876", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "0.601", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "blood", label: "Kan", densityValue: "1060", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "3.5", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "wine", label: "Şarap", densityValue: "990", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "1.5", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
    { id: "beer", label: "Bira", densityValue: "1010", densityUnit: calculatorUnitSymbols.kilogramPerCubicMetre, viscosityValue: "2", viscosityUnit: calculatorUnitSymbols.millipascalSecond },
