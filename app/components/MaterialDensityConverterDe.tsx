...
type MaterialDensityConverterDeProps = {
  densityKgM3: number;
  materialName: string;
};

export default function MaterialDensityConverterDe({
  densityKgM3,
  materialName,
}: MaterialDensityConverterDeProps) {
    ...
    <div className="category-general-converter">
      <div className="paint-calculator-grid">
        <label className="category-general-converter-field">
          <span>Dichte von {materialName} umrechnen</span>
          <select
            value={targetSymbol}
          ...
          <table className="conversion-table">
            <tbody>
              <tr className="is-active">
                <td>
                  <strong>{densityKgM3.toLocaleString("de-DE")} kg/m³</strong>
                </td>
                <td>
                  <strong>
                    {convertedValue.toLocaleString("de-DE", {
