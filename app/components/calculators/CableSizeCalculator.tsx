...
const copy = {
  tr: {
    ...
    threePhase: "Üç faz",
    dc: "DC",
    materialLabel: "İletken malzemesi",
    copper: "Bakır",
    aluminum: "Alüminyum",
    sourceVoltageValue: "Kaynak gerilimi",
    currentValue: "Hat akımı",
    lengthValue: "Kablo uzunluğu (tek yön)",
    allowedDropValue: "İzin verilen gerilim düşümü (%)",
    requiredValue: "Gerekli minimum kesit",
    standardValue: "Önerilen standart kesit",
    standardOutOfRange:
      "Standart tablo dışında; özel bir kesit değerlendirilmelidir.",
    allowedDropVolts: "İzin verilen düşüm",
  ...
  de: {
    ...
    allowedDropValue: "Zulässiger Spannungsfall (%)",
    requiredValue: "Erforderlicher Mindestquerschnitt",
    standardValue: "Empfohlener Normquerschnitt",
    standardOutOfRange:
      "Außerhalb der Normtabelle; ein Sonderquerschnitt sollte geprüft werden.",
    allowedDropVolts: "Zulässiger Fall",
