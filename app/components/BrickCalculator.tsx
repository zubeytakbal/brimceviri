...
> = {
  ...
  fr: {
    ...
    resultLabels: {
      brickArea: "Surface d'une brique avec joint",
      totalArea: "Surface totale avec pertes",
      count: "Bricks needed",
    },
  ...
  es: {
    ...
    resultLabels: {
      brickArea: "Superficie de un ladrillo con junta",
  ...
  pt: {
    ...
    resultLabels: {
      brickArea: "Área de um tijolo com junta",
      totalArea: "Área total com perdas",
      count: "Bricks needed",
    },
  ...
  it: {
    ...
    resultLabels: {
      brickArea: "Superficie di un mattone con giunto",
  ...
  nl: {
    ...
    resultLabels: {
      brickArea: "Oppervlakte van één steen met voeg",
      totalArea: "Totale oppervlakte met snijverlies",
      count: "Bricks needed",
    },
  ...
  sv: {
    ...
    resultLabels: {
      brickArea: "Yta per tegelsten inklusive fog",
  ...
  no: {
    ...
    resultLabels: {
      brickArea: "Areal per murstein inkludert fuge",
      totalArea: "Totalt areal inkludert svinn",
      count: "Bricks needed",
    },
  ...
  da: {
    ...
    resultLabels: {
      brickArea: "Areal pr. mursten inklusive fuge",
      totalArea: "Samlet areal inklusive spild",
      count: "Bricks needed",
    },
