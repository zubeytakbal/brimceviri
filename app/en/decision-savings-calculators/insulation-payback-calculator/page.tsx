...
export const metadata: Metadata = { title: `Insulation Payback Calculator | ${SITE_NAME}`, description: "Estimate wall heat-loss reduction, annual energy savings and simple insulation payback with your own assumptions.", alternates: { canonical: pagePath, languages: { en: pagePath } }, openGraph: { title: "Insulation Payback Calculator", description: "Estimate wall heat-loss reduction and a simple insulation payback.", url: buildSiteUrl(pagePath), siteName: SITE_NAME, locale: "en_US", type: "website" } };
