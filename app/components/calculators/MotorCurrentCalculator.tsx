...
const copy = {
  tr: {
    ...
    singlePhase: "Tek faz",
    threePhase: "Üç faz",
    powerValue: "Motor gücü",
    voltageValue: "Besleme gerilimi",
    powerFactorValue: "Güç faktörü",
    efficiencyValue: "Verim",
    marginValue: "Emniyet payı (%)",
    flaValue: "Tam yük akımı (FLA)",
    designValue: "Tasarım akımı (FLA + emniyet payı)",
    ...
    normalizedFactors: "Kullanılan faktörler",
