...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/it/kitchen-measurement-converter",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/it/kitchen-measurement-converter"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/it/historical-units">Unità di misura storiche</Link>
            </li>
            <li>
              <Link href="/it/categories/massa">Conversione di unità di massa</Link>
            </li>
          </ul>
        </section>
