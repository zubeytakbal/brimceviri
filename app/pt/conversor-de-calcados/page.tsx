...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/pt/conversor-de-calcados",
    languages: {
  ...
  openGraph: {
    ...
    url: buildSiteUrl("/pt/conversor-de-calcados"),
      ...
      <div className="all-conversions-shell">
        ...
        <section className="conversion-section related-conversions">
          ...
          <ul className="related-conversion-list">
            ...
            <li>
              <Link href="/pt/categorias/comprimento">Conversão de unidades de comprimento</Link>
            </li>
          </ul>
        </section>
