...
export const metadata: Metadata = { title: `Solar Payback Calculator | ${SITE_NAME}`, description: "Estimate solar production, self-consumption, export value and simple payback with local production and tariff assumptions.", alternates: { canonical: pagePath, languages: { en: pagePath } }, openGraph: { title: "Solar Payback Calculator", description: "Estimate solar production, self-consumption value, export value and simple payback.", url: buildSiteUrl(pagePath), siteName: SITE_NAME, locale: "en_US", type: "website" } };
