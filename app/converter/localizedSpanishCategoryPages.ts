...
export const spanishCategoryPages: LocalizedSpanishCategoryPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "El kilometro por hora (km/h) es la unidad estandar de velocidad vial en los paises que usan el sistema metrico, entre ellos Espana. La milla por hora (mph) se prefiere en paises que usan el sistema de medidas britanico, como Estados Unidos y el Reino Unido.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "El bit (digito binario) es la unidad de informacion mas pequena que puede procesar un ordenador y solo puede tomar dos valores: 0 o 1. Ocho bits juntos forman un byte; un byte puede representar 256 (2⁸) valores distintos -- suficiente, por ejemplo, para codificar un caracter de texto.",
      ...
      },
      {
        ...
        paragraphs: [
          "Como los ordenadores funcionan en sistema binario, el direccionamiento de memoria esta naturalmente ligado a potencias de 2 (como 1024, 1 048 576). Por eso el mundo del software ha entendido historicamente por 'kilobyte' 1024 bytes.",
  ...
  },
  {
    ...
    facts: [
      ...
      { label: "Tension de red en Espana", value: "230 V (monofasica), 400 V (trifasica)" },
    ],
    sections: [
      {
      ...
      {
        title: "La tension de red en Espana y en el mundo",
        paragraphs: [
          "En Espana, la tension de red estandar de las instalaciones residenciales es de 230 voltios para monofasico, y de 400 voltios para los sistemas trifasicos usados en instalaciones industriales y comerciales (con una frecuencia de 50 Hz).",
          "En el mundo, la tension de red varia segun el pais; Estados Unidos y Canada usan 120 voltios, mientras que la mayoria de los paises europeos, entre ellos Espana, prefieren 230 voltios. Esta diferencia es la razon principal por la que los aparatos electricos traidos del extranjero no pueden usarse directamente sin un convertidor.",
        ],
      },
      {
        title: "Corriente continua (CC) y corriente alterna (CA)",
        paragraphs: [
          "En la corriente continua (CC), los electrones fluyen de forma constante en una sola direccion -- las pilas y los paneles solares producen CC. En la corriente alterna (CA), la direccion de la corriente se invierte con una frecuencia determinada cada segundo (50 Hz en Espana, es decir, 50 veces por segundo) -- la electricidad de la red es CA.",
